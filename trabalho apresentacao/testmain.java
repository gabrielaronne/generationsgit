...
public class testmain {
	...
	System.out.println("digite a frequencia que vc faz uso de medicamentos: 1-com pouca frequencia / 2- frequencia / 3- com muita frequencia");
	int Usomedicamento=leia.nextInt();
	ansiedade.setUsomedicamento(Usomedicamento);
	
	System.out.println("Digite o seu nivel de sedentarismo: 1- pouco sedentario / 2-sedentario / 3-muito sedentario");
	int Nivelsdentarismo=leia.nextInt();
	ansiedade.setNivelsedentarismo(Nivelsdentarismo);
	
	
	System.out.println("digite o seu nivel de agitacao: 1-pouco agitado / 2-agitado / 3-muito agitado");
	int niveldeagitacao=leia.nextInt();
	ansiedade.setNiveldeagitacao(niveldeagitacao);
	
	
	System.out.println("digite o seu nivel de transtorno de ansiedade: 1- pouco ansioso / 2-controlavel / 3-incontrolavel");
